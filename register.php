    ...
    if(isset($_POST["btn_submit_register"]) && !empty($_POST["btn_submit_register"])){
        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
			...
			//***********************************************************************************************************
			  ...
			  if(isset($_POST["patronymic_name"])){

                //Обрезаем пробелы с начала и с конца строки
                $patronymic_name = trim($_POST["patronymic_name"]);

                if(!empty($patronymic_name)){
                    // Для безопасности, преобразуем специальные символы в HTML-сущности
                    $patronymic_name = htmlspecialchars($patronymic_name, ENT_QUOTES);
                }else{
   ...
   //*************************************************************************************************************************
        ...
        //**************************************************************************************************************************    
          ...
          //*********************************************************************************************************************
            ...
            $result_query_insert = $mysqli->query("INSERT INTO `users` (first_name, last_name, patronymic_name, email, login, password) VALUES ('".$first_name."', '".$last_name."', '".$patronymic_name."', '".$email."', '".$login."', '".$password."')");
